...
var reqCon = new signalR.HubConnectionBuilder().withUrl("http://localhost:7187/requestMessages").build();
var cerCon = new signalR.HubConnectionBuilder().withUrl("http://localhost:7187/certificateMessages").build();
